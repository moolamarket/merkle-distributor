  ...
  describe('#claim', () => {
    ...
    describe('two account tree', () => {
      ...
      it('gas', async () => {
        ...
        expect(receipt.gasUsed).to.eq(78129)
      })
    })
    describe('larger tree', () => {
      ...
      it('gas', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(80818)
      })
      ...
      it('gas second down about 15k', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(65798)
      })
    })
    ...
    describe('realistic size tree', () => {
      ...
      it('gas', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(92353)
      })
      it('gas deeper node', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq(92289)
      })
